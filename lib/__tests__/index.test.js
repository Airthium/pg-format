...
//       format('some %1$s %2$s', 'thing', 'again').should.equal(
//         'some thing again'
//       )
//       format('some %1$s %2$s %1$s', 'thing', 'again').should.equal(
//         'some thing again thing'
//       )
//       format('some %1$s %2$s %s %1$s', 'thing', 'again', 'some').should.equal(
...
//       format('some %1$I %2$I', 'thing', 'again').should.equal(
//         'some thing again'
//       )
//       format('some %1$I %2$I %1$I', 'thing', 'again').should.equal(
//         'some thing again thing'
//       )
//       format('some %1$I %2$I %I %1$I', 'thing', 'again', 'huh').should.equal(
...
//       format('%L', testNestedArray).should.equal(
//         "('1', '2'), ('3', '4'), ('5', '6')"
//       )
//     })
...
//       format('some %1$L %L', 'thing', 'again').should.equal(
//         "some 'thing' 'again'"
//       )
//       format('some %1$L %2$L', 'thing', 'again').should.equal(
//         "some 'thing' 'again'"
//       )
//       format('some %1$L %2$L %1$L', 'thing', 'again').should.equal(
//         "some 'thing' 'again' 'thing'"
//       )
//       format('some %1$L %2$L %L %1$L', 'thing', 'again', 'some').should.equal(
//         "some 'thing' 'again' 'some' 'thing'"
//       )
//     })
...
//     it('should format as a simple string', function () {
//       format
//         .withArray('some %s here', ['thing'])
//         .should.equal('some thing here')
//       format
//         .withArray('some %s thing %s', ['long', 'here'])
//         .should.equal('some long thing here')
//     })

//     it('should format array of array as simple string', function () {
//       format
//         .withArray('many %s %s', ['things', testNestedArray])
//         .should.equal('many things (1, 2), (3, 4), (5, 6)')
//     })
//   })
...
//       format
//         .withArray('just %% a %s %s %s', ['test', 'again', 'and again'])
//         .should.equal('just % a test again and again')
//     })
//   })
...
//     it('should format as an identifier', function () {
//       format
//         .withArray('some %I', ['foo/bar/baz'])
//         .should.equal('some "foo/bar/baz"')
//       format
//         .withArray('some %I and %I', ['foo/bar/baz', '#hey'])
//         .should.equal('some "foo/bar/baz" and "#hey"')
//     })
...
//       format
//         .withArray('%L %L', ["Tobi's", 'birthday'])
//         .should.equal("'Tobi''s' 'birthday'")
//     })

//     it('should format array of array as a literal', function () {
//       format
//         .withArray('%L', [testNestedArray])
...
//     format.ident(-45.13).should.equal('"-45.13"')
//     format
//       .ident(testIdentArray)
//       .should.equal('abc,"AbC","1","t","2012-12-14 13:06:43.152+00"')
//     ;(function () {
...
//     format
//       .literal(testArray)
//       .should.equal("'abc','1','t',NULL,'2012-12-14 13:06:43.152+00'")
//     format
//       .literal(testNestedArray)
//       .should.equal("('1', '2'), ('3', '4'), ('5', '6')")
